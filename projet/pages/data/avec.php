...
for ($i=0; $i < count($get); $i++) { 
  if($get[$i]['latitude'] != -1 && $get[$i]['longitude'] != -1 && $get[$i]['altitude'] != -1) {
    ...
    <div class="contents">
      ...
      <a href="https://www.google.com/maps/dir//' . $get[$i]['latitude'] . ',' . $get[$i]['longitude'] . '" id="coordonnees">Coordonnées</a>
      <p id="latitude">' . $get[$i]['latitude'] . '</p>
      <p id="longitude">' . $get[$i]['longitude'] . '</p>
      <p id="altitude">' . $get[$i]['altitude'] . '</p>
